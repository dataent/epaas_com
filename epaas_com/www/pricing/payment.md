...
<table class="table table-bordered table-hover">
	...
	<tbody>
		{% for plan in [
			...
			<!-- {% set inr = dataent.utils.fmt_money(
				dataent.utils.cint(dataent.utils.flt(dataent.utils.flt(plan.usd[1:]) * 60.0 * 1.1236 / 1000.0, 0) * 1000),
				precision=0,
				currency="INR") %} -->
			{% set inr = dataent.utils.fmt_money(plan.inr,
				precision=0,
				currency="INR") %}
			<tr>
				<td>{{ plan.name }}</td>
	...
	<table class="table table-bordered table-hover">
		<tbody>
			...
			<tr>
				...
				<td>Dataent Technologies Pvt. Ltd.</td>
			</tr>
			<tr>
				<td>IFSC Code</td>
				<td>HDFC0001473</td>
...
<div class="india-wire-transfer-msg hidden">
	...
	<p>
		<b>Dataent Technologies Pvt Ltd.</b> <br>
