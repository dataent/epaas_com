...
@dataent.whitelist(allow_guest=True)
def signup(last_name, email, subdomain, company_name, phone_number, plan=None, distribution="epaas", res=None):
	status = _signup(last_name, email, subdomain, plan=plan,
